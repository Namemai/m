...
#==============================================================================#
                        ...
                        ki21.sendMessage(msg.to,"➲ 21  มาครับเจ้านาย")
                        ki22.sendContact(to, ki12MID)
                        ki22.sendMessage(msg.to,"➲ 22  มาครับเจ้านาย")
                        ki23.sendContact(to, ki12MID)
                        ki23.sendMessage(msg.to,"➲ 23  มาครับเจ้านาย")
                        ki24.sendContact(to, ki12MID)
                        ki24.sendMessage(msg.to,"➲ 24  มาครับเจ้านาย")
                        ki25.sendContact(to, ki12MID)
                        ki25.sendMessage(msg.to,"➲ 25  มาครับเจ้านาย")
                        ki26.sendContact(to, ki12MID)
                        ki26.sendMessage(msg.to,"➲ 26  มาครับเจ้านาย")
                        ki27.sendContact(to, ki12MID)
                        ki27.sendMessage(msg.to,"➲ 27  มาครับเจ้านาย")
                        ki28.sendContact(to, ki12MID)
                        ki28.sendMessage(msg.to,"➲ 28  มาครับเจ้านาย")
                        ki29.sendContact(to, ki12MID)
                        ki29.sendMessage(msg.to,"➲ 29  มาครับเจ้านาย")
                        ki30.sendContact(to, ki12MID)
                        ki30.sendMessage(msg.to,"➲ 30  มาครับเจ้านาย")
